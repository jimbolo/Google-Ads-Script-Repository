...
function main() {
  ...
  //var statColumns = ["Clicks", "Impressions", "Cost", "ConversionTypeName", "Conversions", "ConversionValue"];
  //Invalid reporting query: Cannot select a combination of Clicks and ConversionCategoryName,ConversionTrackerId,ConversionTypeName,ExternalConversionSource. (line 232)
